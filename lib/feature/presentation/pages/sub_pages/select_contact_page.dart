...
import '../../cubit/get_device_number/get_device_numbers_dart_cubit.dart';
...
class SelectContactPage extends StatefulWidget {
  ...
  const SelectContactPage({required Key? key , required this.userInfo}) : super(key: key);
            ...
            onTap: () {
              Navigator.push(context, MaterialPageRoute(
                  builder: (_) => SingleCommunicationPage(
                    ...
                    senderPhoneNumber: widget.userInfo.phoneNumber, key: null
                  )
              ));
